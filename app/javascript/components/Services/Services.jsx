...
class Services extends React.Component {
    ...
    componentDidMount() {
    const url = "/api/v1/services/index";
    fetch(url)
      .then(response => {
        if (response.ok) {
    ...
    handleSubmit(event) {
        ...
        const url = "/api/v1/services/import";
        ...
        fetch(url, {
          ...
          .then(response => this.setState({ services: response.services, loading: false }))
          .catch(error => console.log(error.message));
    }
        ...
        <div className="pd24">
            ...
            <Row className=" loader_box align_center">
              <Col sm={12} lg={6}>
                ...
                <div key={index}>
                  <div className="texte_etiquette">{service.nom}</div>
                </div>
                ))}
              </Col>
              <Col sm={12} lg={6}>
